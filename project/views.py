...
def tasks():
    ...
    g.db.close()
    return render_template("tasks.html", form=AddTaskFrom(request.form), open_tasks=open_tasks, closed_tasks=closed_tasks)
